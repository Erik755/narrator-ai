...
# Main UI: API key is encrypted on-device using GeminiSecretStore/Android Keystore.
    ...
    '''        root.addView(info);
        ...
        saveGemini.setOnClickListener(v -> {
            ...
            if (key.isEmpty()) {
                ...
                geminiKey.setText("");
                geminiInfo.setText("Gemini 3.6 Flash configurado · clave cifrada con Android Keystore. Reinicia el asistente para aplicarlo.");
            }
        });
...
print("patch_v26_fixed: Gemini 3.6 hybrid brain + encrypted key UI applied")
