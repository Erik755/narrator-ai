...
# LocalLanguageAgent: reflect current Gemini model and require confidence for cloud actions.
...
# Main UI: current model name, explicit test/clear buttons, and a security explanation.
